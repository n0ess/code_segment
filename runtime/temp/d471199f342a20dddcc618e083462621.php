<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:63:"D:\web\codep\trunk\public/../app/admin\view\authrule\index.html";i:1487879396;s:55:"D:\web\codep\trunk\public/../app/admin\view\layout.html";i:1487879396;s:65:"D:\web\codep\trunk\public/../app/admin\view\.\_layout\header.html";i:1487879396;s:66:"D:\web\codep\trunk\public/../app/admin\view\.\_layout\sidebar.html";i:1487879396;s:62:"D:\web\codep\trunk\public/../app/admin\view\.\_layout\top.html";i:1487879396;s:65:"D:\web\codep\trunk\public/../app/admin\view\.\_layout\footer.html";i:1487879396;}*/ ?>
<!-- head -->
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins" style="background: white;padding: 10px">
                ...
                <div class="ibox-content">
                    <!-- 用户控件（操作） -->
                    <div id="toolbar" class="toolbar" data-module="/admin/Authrule"><div class="btn-group"><button type="button" data-name="add" class="btn btn-primary" data-event-type="view" data-event-value=""  data-target="modal"><i class="fa fa-plus" aria-hidden="true" style="margin-right: 2px"> </i><?php echo \think\Lang::get('Add'); ?></button><button type="button" data-name="delete" class="btn btn-default" data-event-type="default" data-event-value="" data-target="modal"><i class="fa fa-trash" aria-hidden="true" style="margin-right: 2px"> </i><?php echo \think\Lang::get('Delete'); ?></button></div>
                       
                    </div>
                    <!-- 表格数据 -->
                    <table id="table" data-toggle="gridview" class="table" data-url="<?php echo url('admin/authrule/getData');; ?>" data-toolbar="#toolbar" data-show-columns="true" data-page-size="5" data-page-list="[5, 25, 50, All]" data-unique-id="id" data-pagination="true" data-side-pagination="client" data-click-to-select="false">
					    <thead>
					        <tr>
					            <th data-width="40"  data-align="center"  data-checkbox="true"></th>
					            <th data-width="50" data-field="id">ID</th>
					            <th data-field="title"><?php echo lang('Auth Name'); ?></th>
...
<script type="text/javascript">
    ...
    var operateEvents = {
        'click .edit': function (e, value, row, index) {
            var param = {
                url: "<?php echo url('admin/authrule/edit'); ?>",
                data: {id: row.id}
            }
