...
return [
 ...
 //        // 模板后缀
 //        // 'view_suffix'  => 'html',
 //        'taglib_pre_load'    =>    'think\template\taglib\Cx,app\home\taglib\Tool',
 //        'taglib_build_in'    =>    'think\template\taglib\Cx,app\home\taglib\Tool',
	// ],
    //缓存
    'cache'                             => [
        // 驱动方式
        'type'   => 'File',
        // 缓存保存目录
        'path'   => RUNTIME_PATH.'system/homeData/',
        // 缓存前缀
        'prefix' => '',
        // 缓存有效期 0表示永久缓存
        'expire' => 0,
